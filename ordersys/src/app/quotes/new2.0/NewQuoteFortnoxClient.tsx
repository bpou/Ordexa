...
import { FORTNOX_UNIT_OPTIONS, normalizeFortnoxUnitCode, useNewOrderForm } from "../../orders/new/useNewOrderForm";

import type { Account, Article, Row } from "../../orders/new/useNewOrderForm";
...
export default function NewQuoteFortnoxClient({ defaultOurReference = "" }: { defaultOurReference?: string }) {
  ...
  const {
    ...
    defaultOurReference,
    submitUrl: "/api/fortnox/offers",
    convertToOrderPath: "/orders/new2_0?convertedFrom=quote",
  });
      ...
      <div className="rounded-md border border-[#d9ddd4] bg-white shadow-sm">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#d9ddd4] bg-[#f1f3ee] px-6 py-4">
          ...
          <div>
            ...
            <h1 className="text-xl font-semibold text-[#2d3329]">Ny offert</h1>

            <p className="text-sm text-[#6b7165] mt-1">Skapa en ny offert i Fortnox</p>
        ...
        <div className="space-y-8 px-6 py-6">
          ...
          <div className="grid gap-6 md:grid-cols-12">
            ...
            <FortnoxField label="Kund" className="md:col-span-4">
              ...
              <div className="relative" ref={customerDropdownRef}>
                ...
                >
                  ...
                  <span className={`transition-transform ${customerDropdownOpen ? "rotate-180" : ""}`}>â–¼</span>
            ...
            <FortnoxField label="Offertdatum" className="md:col-span-2">
            ...
            <FortnoxField label="Giltig t.o.m." className="md:col-span-2">
          ...
          <FortnoxSection title="Offertuppgifter">
            ...
            <div className="grid gap-4 md:grid-cols-16">
              ...
              <FortnoxField label="Ert offertnummer" className="md:col-span-4 md:col-start-1">
          ...
          <FortnoxSection title="Offertrader">
            <div className="space-y-3">
              <div className="relative rounded-md border border-[#d9ddd4]">
                <div className="grid grid-cols-35 divide-x divide-[#d9ddd4] border-b border-[#d9ddd4] bg-[#f1f3ee] text-[10px] font-semibold uppercase tracking-[0.12em] text-[#4f5a49]">
                  ...
                  <div className="col-span-2 flex items-center justify-center px-3 py-2">Á-pris</div>
