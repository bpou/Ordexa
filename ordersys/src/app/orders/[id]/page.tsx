...
type OrderDetailTab = "overview" | "communication" | "economy" | "files" | "notes";
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-none">
      <button
        ...
        className="flex w-full items-center justify-between gap-3 bg-neutral-50 px-5 py-4 text-left text-neutral-900 transition hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-300"
        aria-expanded={open}
      >
          <span className="inline-flex items-center gap-3">
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-neutral-200 bg-white text-neutral-600">
...
function TrackCard({
  ...
  return (
    <div className="group rounded-2xl border border-neutral-200 bg-white p-4 shadow-none transition hover:border-neutral-300">
      ...
      <div className="mt-2 divide-y divide-neutral-100">
        <div className="flex items-center justify-between gap-3 py-3">
          <div className="text-sm text-neutral-600">Tid loggad</div>
          <motion.div
            key={`${track}-${timeSpent}`}
        ...
        <button
          ...
          disabled={!canManage}
          className="flex w-full items-center justify-between gap-3 py-3 text-left transition hover:text-brand-700 disabled:cursor-default disabled:hover:text-inherit"
        >
          <div className="text-sm text-neutral-600">Planering</div>
